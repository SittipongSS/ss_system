-- ============================================================
--  Migration 0371: ชนิดราคาวัตถุดิบ "B" (เบส) — RM_B
--
--  ⚠️ **เคยเป็นเลข 0370** — รันบน prod แล้ว 2026-09-22 ในชื่อ 0370_material_kind_base.sql (ยืนยัน 7 CHECK ครบ)
--     แล้วชนกับ 0370_product_spec_document_model.sql (#1764) ที่ merge ก่อน ⇒ ย้ายเลขตอน rebase · **ไม่ต้องรันซ้ำ**
