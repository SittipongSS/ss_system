-- 0304 - เปลี่ยนชื่อ service_sites.zone เป็น "routeZone" (เขตวิ่งงาน)
--
-- ⚠️ **ใบนี้เคยชื่อ 0296 และถูกรันจริงบน Supabase ไปแล้ว 2026-08-28 ตอนยังใช้เลขนั้น**
-- เปลี่ยนเลขเพราะ 0296 ถูกใช้ไปแล้วโดย `0296_customer_name_title.sql` บน main
-- (ลงฐานไปแล้วเหมือนกัน) — เลขซ้ำสองใบคือสิ่งที่ check:migrations ห้ามไว้
-- เนื้อในไม่เปลี่ยน และ idempotent อยู่แล้ว รันซ้ำก็ไม่มีอะไรเกิดขึ้น
--
