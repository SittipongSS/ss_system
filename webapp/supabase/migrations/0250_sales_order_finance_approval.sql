-- ============================================================
--  Migration 0250: ขั้นบัญชีตรวจใบสั่งขาย หลัง AE Supervisor อนุมัติ (มติผู้ใช้ 2026-08-13)
--
...
COMMENT ON COLUMN public.sales_orders."financeStatus" IS
  'ขั้นบัญชีตรวจ (0250) — NULL = ยังไม่ถึงคิว/ออกก่อนมีขั้นนี้ · คนละแกนกับ status ไม่แตะ Actual';
