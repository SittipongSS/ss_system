...
--      ตัดทิ้ง  : 'L' — ใบเดียวที่ใช้ (FG-112-02-011-0360 Reed Diffuser Bulk) ผู้ใช้แก้เอง
--                 ในระบบเป็น '1 kg' แล้วเมื่อ 2026-08-20 ⇒ ตอนนี้ไม่มีสินค้าใบไหนเหลือ 'L'
--                 ท่อน UPDATE ด้านล่างจึงเป็น **ตาข่ายรับ** ไม่ใช่งานหลัก: กันแถวใน
--                 sales_deal_value_items (ตารางนั้นรับข้อความอิสระ ไม่ผูกลิสต์) และกัน
--                 กรณีมีคนกรอก 'L' แทรกเข้ามาระหว่างนี้ · ไม่เจอแถว = ผ่านเงียบ ๆ ถูกแล้ว
...
--    ตอนเขียนไม่มีแถวไหนเข้าเงื่อนไขแล้ว (ดูหัวไฟล์) — ปล่อยไว้เป็นตาข่ายรับ
