-- ============================================================
--  Migration 0310: ทะเบียนทีม + ทีมปฏิบัติงาน (docs/team-management-plan.md)
--
--  ⚠️ **ใบนี้เคยชื่อ 0308 และถูกรันจริงบน Supabase ไปแล้ว 2026-08-28 ตอนใช้เลขนั้น**
--  แล้วขยับเป็น 0309 → 0310 เพราะเซสชันอื่นใช้สองเลขนั้นไปก่อนและ merge เข้า main
--  ก่อนใบนี้ (0308_workflow_step_role_lg_to_ra · 0309_trim_fg_code_all_whitespace)
--  — เลขซ้ำสองใบคือสิ่งที่ check:migrations ห้ามไว้
