...
--
-- 🔄 **แก้ไขทีหลังโดย mig 0248 (มติผู้ใช้ 2026-08-13)** — กติกาข้างล่างยังจริงทุกคำสำหรับ
--   แถวที่ **เคยผ่านอนุมัติ** แต่ AR/FG ที่เป็นร่างซึ่งไม่เคยอนุมัติเลย ลบแล้วเลขกลับมา
--   ใช้ได้ ผ่านตาราง `entity_number_reclaimed` ⇒ อ่านใบนี้คู่กับ 0248 เสมอ
--   (ตัวเคาน์เตอร์และ trigger ทั้งหมดในใบนี้ไม่ถูกแตะ — 0248 ไม่ได้ถอยเคาน์เตอร์)
--
