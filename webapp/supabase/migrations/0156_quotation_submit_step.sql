-- 0156 - ใบเสนอราคามี "ขั้นยื่นอนุมัติ" + ยื่น = การลงนามของผู้เสนอราคา
--
-- ⚠️ เดิมไฟล์นี้ชื่อ 0155 ซึ่งชนกับ 0155_sales_order_number_pattern.sql ที่เข้า main ก่อน
--    (01:01 vs 01:20 ของวันเดียวกัน) → check:migrations แตกเพราะเลขซ้ำ จึงเปลี่ยนเป็น 0156
--    **เนื้อหา SQL ไม่เปลี่ยนเลย และไฟล์นี้รันบน prod ไปแล้วในชื่อ 0155 (2026-07-26 —
--    ยืนยันแล้ว: fn_submit=1, still_pending=0) ไม่ต้องรันซ้ำ**
