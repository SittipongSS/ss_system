-- ============================================================
--  Migration 0235: ช่อง "เอกสารอ้างอิง" ของใบสั่งขาย (IS-26080017 · มติผู้ใช้ 2026-08-12)
--
--  ⚠️ ใบนี้เข้า main ในชื่อ 0234 (#1182) ชนกับ 0234_lead_bounce_round (#1170) ที่ merge
--  ก่อนหน้าไม่กี่นาที — CI ของ main แดงทันทีที่ทั้งคู่มาอยู่ด้วยกัน จึงเลื่อนใบนี้เป็น 0235
--  (เลือกเลื่อนใบนี้เพราะอีกใบถูกรันบนฐานจริงไปแล้ว) · ถ้ารัน 0234 เดิมไปแล้วไม่ต้องรันซ้ำ
--  — คำสั่งข้างล่างเป็น IF NOT EXISTS ทั้งหมด รันซ้ำก็ไม่เสียหาย
--
