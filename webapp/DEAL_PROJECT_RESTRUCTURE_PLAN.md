...
>
> สถานะ: **ร่างเพื่อรีวิว — ยังไม่ลงมือ** (อัปเดต 2026-07-11 รอบ 3 — กลับมาใช้ 3 ประเภท ตามมติผู้ใช้)
...
3. deploy ข้อ 1–2 → รัน migration 0089 บน prod (SCENT ใน projects.type + ดรอป unique)
...
| timeline เพี้ยนเมื่อต่อ task ชุดใหม่ | ทุกชุดต่อท้ายเป็น draft ต้องยืนยัน + forward-only anchor เดิม |
...
- เฟส 2: ดีล SCENT ก่อตั้งโครงการ → timeline มีเฉพาะขั้นออกแบบกลิ่น; ดีล NPD link เข้าโครงการเดิม →
  task ชุด Mock-up→ส่งมอบ ต่อท้ายเป็น draft; หน้าโครงการโชว์ 2 ดีล + rollup ถูก (AT=won, FC=open, byType แยก);
