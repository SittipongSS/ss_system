...
| สินค้า | `Package` |
| ใบเสนอราคา | `FileText` |
| ใบสั่งขาย · คำร้อง | `ClipboardList` |
| งาน | `ListTodo` |
...
**ที่เจ็บมาแล้ว** — ก่อน 2026-08-14 `FolderKanban` ถูกใช้แทนทั้งดีลและโครงการพร้อมกัน
14 ไฟล์ ส่วนเมนูโครงการใช้ `Boxes` ซึ่งซ้ำกับทะเบียนวัสดุและ "ของเข้า (สหมิตร)" อีกต่อ
