...
|---|---|---|
| `RAW_SPACING_CAP` | 154 | เลขคี่ (5 · 3 · 9 · 7 · 11px) — จังหวะ 2px ที่เหลือถูกตั้งชื่อเป็น `--space-*-5` ไปแล้ว · ⚠️ **นับเฉพาะไฟล์ `.css`** · 📉 **155 → 154 (2026-09-06)** `22px` ดิบที่หัวการ์ด `.overviewHeading` ยกเข้า `--panel-inset` ตอนยุบขอบในของหัวการ์ดทุกตระกูลให้เหลือเส้นเดียว |
