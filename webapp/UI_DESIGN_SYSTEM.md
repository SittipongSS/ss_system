...
ใช้ `SquareKanban` ไม่ใช่ `FolderKanban` และการ์ดที่รวมของหลายชนิด (โครงการ + ดีล +
คำร้อง) ใช้ไอคอนกลางอย่าง `Link2` ไม่ใช่ไอคอนของชนิดใดชนิดหนึ่ง
...
ทั้งที่สินค้ามี `Package` เป็นของตัวเองอยู่แล้ว อีกต่อ
