...
> **สถานะ build:** settle-deal เปลี่ยนเป็น "ยืนยันดีล+ผูกโครงการ+ออก QT" (ราคา master,
> เข้าคิวเจ้าของเซ็น), create-project เหลือสร้างโครงการอย่างเดียว, partial PO มีตัวเลือก
> แบ่งดีล (ดีลลูกเปิด ไม่ใช่ Won)/ใช้ทั้งดีล, PO นอก forecast สร้างดีลเปิด (ไม่ใช่ won stub).
> ขั้น Won (แนบไฟล์ PO + เลือกเดือน) และ SO ใช้ route มาตรฐานเดิม ไม่มีโค้ดใหม่.
> core สร้าง QT แยกเป็น lib ใช้ร่วม: `src/lib/sales/createQuotationDraft.js`.
