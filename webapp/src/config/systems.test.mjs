...
test('⭐ ระบบที่ยังไม่เปิดใช้ยังอยู่ในรายการของทุกคนที่เข้าได้', () => {
  ...
  /* ⚠️ `production` **ยังจางอยู่** — มติผู้ใช้ 2026-09-16 แคบ *คนเห็น* เหลือ PD กับ admin
     (ที่ `canViewProduction`) แต่ไม่ได้สั่งให้เปิดใช้ · เคยถอด `disabled` ออกไปหนึ่งรอบ
     แล้วผู้ใช้ทักว่าเกินที่สั่ง ⇒ สองเรื่องนี้แยกกันเสมอ: "ใครเห็น" กับ "กดได้หรือยัง" */
