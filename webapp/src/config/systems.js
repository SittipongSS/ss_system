import { Briefcase, CircleDollarSign, Database, Factory, LifeBuoy, LineChart, Scale, Wrench } from 'lucide-react';
...
export const SYSTEM_CATALOG = [
  ...
  {
    // แจ้งปัญหาระบบ (mig 0219) — ระบบเดียวที่ **ทุกคนที่ล็อกอินเห็น** ไม่มีเงื่อนไข
