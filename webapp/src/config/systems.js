...
export const SYSTEM_CATALOG = [
  ...
  },
  {
    ...
    // ⚠️ ลงที่คิวคำร้อง ไม่ใช่ `/rd` — หน้าภาพรวมถูกเทาไว้ในเมนู (มติผู้ใช้ 2026-08-15)
    // ปล่อยให้ landing ชี้หน้าที่กดจากเมนูไม่ได้ = กดการ์ดแล้วไปโผล่หน้าที่ระบบเพิ่ง
    // บอกว่ายังไม่เปิด ซึ่งอ่านแล้วขัดกันเอง
    landing: () => '/rd/requests',
  },
  {
  ...
  },
  {
    ...
    /* ⚠️ ลงที่ **ทะเบียนการชำระ** ไม่ใช่ภาพรวม — ภาพรวมถูกพักไว้ (`disabled` ใน AppLayout)
       จนกว่าโมดูลจะมีของมากกว่าหน้าเดียว (มติผู้ใช้ 2026-08-13)
       ⚠️ ปลายทางต้องเป็นหน้าที่กดได้จริงเสมอ — ชี้ไปหน้าที่จางอยู่ = กดการ์ดแล้วไปตัน */
    landing: () => '/finance/payments',
  },
  {
    key: 'tax',
    label: 'ภาษีสรรพสามิต',
