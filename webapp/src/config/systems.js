...
export const SYSTEM_CATALOG = [
  ...
  },
  {
    ...
    /* ⚠️ **ยังไม่เปิดใช้ — คงจางไว้เหมือนเดิม (มติผู้ใช้ 2026-09-16)**
       รอบแรกของวันนั้นถอด `disabled` ออกไปด้วย ซึ่ง **เกินกว่าที่สั่ง** · ผู้ใช้ยืนยันว่า
       ต้องการแค่ "เอาออกจากแผนกอื่น" ไม่ได้ต้องการให้กดเข้าไปได้ ⇒ คืนค่าเดิม
       (เปิดใช้จริงเมื่อไร ถอดบรรทัดนี้บรรทัดเดียว — ดูหมายเหตุที่ SYSTEM_DISABLED_NOTE) */
    disabled: true,
  ...
  },
  {
    ...
    // เคย disabled ตั้งแต่ 2026-08-09 — เปิดคืน 2026-08-27 พร้อมเมนูชุดใหม่ (F-1)
    // ตามแผนระบบธุรกิจบริการเฟส 1: ฝ่าย TS เริ่มใช้ "งานวันนี้ / จัดคิวเจ้าหน้าที่" จริง
