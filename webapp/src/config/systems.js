...
export const SYSTEM_CATALOG = [
  ...
  },
  {
    ...
    icon: Factory,
    // ⭐ **เปิดใช้จริง + เหลือ PD กับ admin เท่านั้น (มติผู้ใช้ 2026-09-16)**
    //    เดิม `disabled: true` ตั้งแต่ 2026-08-09 และ `canViewProduction` กว้างถึง
    //    PC/WH/QC + ฝ่ายขาย/ผู้สังเกตการณ์ ("โรงงานจะผลิตวันไหน") · มติใหม่เปิดโมดูล
    //    ให้เจ้าของงานใช้จริง แล้วค่อยขยายทีหลังถ้ามีคนขอ
