...
export default function ServiceSitesPage() {
  ...
  useEffect(() => {
    ...
    router.replace("/database/sites", { scroll: false });
                  ...
                  return (
                    ...
                    >
                      <td>
                        ...
                        <Link prefetch={false} href={`/database/sites/${site.id}`} className="linklike"><strong className="mono">{site.code || site.name}</strong></Link>
