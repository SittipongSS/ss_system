...
import { LayoutDashboard, Target, Activity, CalendarDays, Inbox, AlertTriangle, ArrowRight, FolderKanban } from "lucide-react";
import Workspace from "@/components/ui/Workspace";
import { useRole, useTeam } from "@/lib/roleContext";
import { fmtMoney, fmtDate } from "@/lib/format";
import { forecastBadge, MonthPicker, thisMonth } from "@/components/salesPlanning/ui";
...
export default function MyDashboardPage() {
  ...
  return (
    <Workspace
      ...
      title="แดชบอร์ดส่วนตัว (My Dashboard)"
      subtitle="ข้อมูลและการดำเนินงานรายวันที่รับผิดชอบ"
