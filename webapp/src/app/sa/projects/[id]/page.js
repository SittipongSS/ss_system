...
export default function ProjectDetailPage() {
  ...
  return (
    <SaPageShell>
      ...
      {/* จุดจัดการเดียวของโครงการ — แถบขวาตลอดทุกแท็บ ท่าเดียวกับหน้าลีด/ดีล/เอกสาร
          การ์ดสถานะการปิดเดิมที่เคยอยู่ตรงนี้ถูกยุบเข้าไปแล้ว (สถานะ+ปุ่ม+หลักฐาน) */}
      <DetailPageLayout aside={controlCard}>
