...
import {
  Boxes, RefreshCw, History, Pencil, FileText, Plus, Check, Archive,
...
export default function MaterialRegistryPage() {
  const role = useRole();
    ...
    <Workspace hideHeader>
      <div className="premium-header">
        <div className="header-content">
          ...
          <p>
            ข้อมูลหลักของราคาวัตถุดิบและบรรจุภัณฑ์ — ใบขอราคาผลิตเลือกวัสดุจากที่นี่
