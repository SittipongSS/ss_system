...
export async function PATCH(request, { params }) {
  ...
  if (body.approvalStatus !== undefined) {
    ...
    await recordAudit({
      ...
      summary: `${body.approvalStatus === 'approved' ? 'อนุมัติ' : body.approvalStatus === 'rejected' ? 'ปฏิเสธ' : 'รีเซ็ตสถานะ'}สินค้า ${decided.productDescription || decided.productDescriptionEn || id}`,
      request,
    });
