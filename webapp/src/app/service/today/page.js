...
export default function TodayPage() {
  ...
  const closeVisit = async (form) => {
    ...
    /* ⛔ รอบถัดไป: เดิมบอก "สร้างนัดได้ที่หน้าจัดคิวเจ้าหน้าที่" ซึ่งทางเดียวบนหน้านั้นคือปุ่ม "+ งานนอกรอบ" —
       ปิดไปแล้ว (มติเจ้าของ 24/09) และปุ่มนั้นสร้างนัด **นอกรอบ** (ไม่มี planId) ไม่ใช่นัดของรอบอยู่ดี
       ⇒ ชี้ทางที่มีอยู่จริง: รอบบริการเติมนัดล่วงหน้า 90 วันอยู่แล้ว (ส่วนใหญ่มีนัดรอบนั้นในรายการงาน) ·
          รอบที่ไม่มีนัดข้างหน้าเลยขึ้นแท็บ "ครบรอบยังไม่มีนัด" ของงานเข้าใหม่ (ลิงก์ไปเติมนัดที่หน้าไซต์)
