    ...
    >
      <div className="flex flex-col gap-4">
        ...
        {awaitingSalesOrderIds.size > 0 && (
          ...
          >
            {/* ทางของยอดมีสามขั้น (มติผู้ใช้ 2026-09-11 · mig 0353): ยื่นใบสั่งขายแล้วยอดขึ้นเป็น
                "รออนุมัติ" ก่อน แล้วค่อยเป็น Actual ตอน AE Supervisor อนุมัติ — ไม่ใช่กดสร้างแล้วเข้าเลย */}
            ดีลปิดได้แล้วแต่เอกสารยังไม่เดินต่อ — เปิดใบแล้วสร้างและยื่นใบสั่งขาย ยอดจะขึ้นเป็น “รออนุมัติ” แล้วเป็น Actual เมื่ออนุมัติ
          </StatusNotice>
        )}
