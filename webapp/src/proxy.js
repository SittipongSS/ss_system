...
const OPEN_PAGES = ['/home', '/pm', '/database', '/tax', '/sahamit', '/mgmt'];
...
const OPEN_WRITE_APIS = ['/api/account', '/api/pm', '/api/customers', '/api/products', '/api/attachments', '/api/upload', '/api/excise-registrations', '/api/orders', '/api/sahamit', '/api/mgmt'];
