...
const SWALLOWED_ONCLICK = [
  /* สองจุดนี้โดนกลืนเพราะ `accept: "image/*"` ที่บรรทัด 74 ของไฟล์เดียวกัน
     ...
     ⚠️ เลขขยับ 428/441 → 434/447 ตอนเติมคอมเมนต์เหนือ effect (2026-09-09) —
        อ่านด้วยมือซ้ำแล้ว ยังเป็น <Button> ทั้งคู่ */
  "src/components/service/CloseVisitSheet.js:434",
  "src/components/service/CloseVisitSheet.js:447",
