...
/* ช่องกรอกกลางของระบบ — ที่เดียวที่ได้รับอนุญาตให้เขียนคลาส `premium-input`
   ...
   - บางจุดเติม `text-[12px]` / `h-[32px]` / `h-[30px]` ทับความสูงมาตรฐาน 36px
   ...
   ⚠️ อย่าเอาไปแทน `.textarea-premium` (17 จุด) — คนละงานกัน ตัวนั้นเป็นกล่อง
   *วางข้อมูลดิบ* (ฟอนต์ mono, สูง 100px, ห้ามลากขยาย) ไม่ใช่ช่องกรอกของฟอร์ม
