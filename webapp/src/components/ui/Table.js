...
export function TableScroll({
  ...
  cells = "default",
  /* ⭐ `pinned` = ครอบความสูงกล่องไว้ที่พื้นที่ที่เหลือใต้แถบเมนู เพื่อให้หัวตาราง
     ปักได้จริง (sticky ต้องมีช่วงเลื่อนใน scrollport ถึงจะทำงาน)

     🔴 **ตั้งต้นเป็นปิด** — #1627 เปิดให้ทุกที่แล้วเจ็บสองทาง:
       1. สูตรเพดานคิดจาก `100dvh − --scroll-anchor-top` (106px) = สมมติว่าตาราง
          เริ่มใต้แถบเมนูทันที · วัดจริงที่ /requests ตารางเริ่มที่ y=639
          ⇒ เพดานสูงเกินความจริง 533px ทุกครั้ง กล่องล้นจอเสมอ = **สกรอลล์สองชั้น**
          (วัด 1366/1440/1920 ได้หน้าเลื่อน 642px เท่ากันหมด — เป็นผลของโครงสร้าง
          ไม่ใช่ของข้อมูล)
       2. จุดที่มีเพดานของตัวเองอยู่แล้ว (.fz-box · .reconciliation-container)
          กลายเป็นกล่องเลื่อนซ้อนกล่องเลื่อน (แก้ไปแล้วใน #1646)

     ⇒ เปิดเป็นรายจุดที่ **วัดแล้วว่าได้ประโยชน์** เท่านั้น คือจุดที่ของเหนือตาราง
     เตี้ยพอให้กล่องพอดีจอจริง ๆ · จุดที่พกเพดานของตัวเองมาไม่ต้องเปิด */
  pinned = false,
  minWidth,
  className = "",
  ...props
