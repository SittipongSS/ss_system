...
/* ⚠️ ชื่อ EXEMPT ชวนให้เข้าใจผิด — `lib/` ไม่ได้ยกเว้นแค่ "เอกสารพิมพ์"
   วัด 2026-09-02: ยกเว้น **487 ไฟล์** คือ src/lib ทั้งชั้น (ตัวประกอบเอกสารพิมพ์
   เป็นแค่ส่วนหนึ่ง) ⇒ ถ้าวันหน้ามีคนเขียนคลาส textarea-premium ลงไฟล์ใน src/lib
   ด่านนี้จะไม่เห็น · แคบขอบเขตให้ตรงเจตนาเมื่อไหร่ ต้องวัดก่อนว่ากระทบกี่ไฟล์
   (เดิมมี "components/documents/" อยู่ด้วย ลบออก 2026-09-02 เพราะยกเว้นศูนย์ไฟล์ —
   โฟลเดอร์ปลดระวางไปแล้ว 2a2eed0b) */
const EXEMPT = ["lib/"];
