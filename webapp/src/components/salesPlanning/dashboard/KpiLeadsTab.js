...
export default function KpiLeadsTab({ month, allMonths = false, teamFilter, rangeFrom = null, rangeTo = null }) {
  ...
  /* ── ลีดเข้ารายวัน/รายสัปดาห์ (IS-26080023) ───────────────────────────────
     ...
     ⭐ ถังรายสัปดาห์เริ่ม **วันอาทิตย์ (อา–ส)** (`weekStartOf`) เหมือนปฏิทินทุกตัว —
     มติเจ้าของ 2026-09-26 (เดิมนับ จ.–อา. ตามที่ Marketing นับ) · 🔴 ห้ามหาวันใน
     สัปดาห์ด้วย `new Date(...).getUTCDay()` เพราะ timestamp มี offset +07 แล้ววันต้น
     สัปดาห์จะตกไปสัปดาห์ก่อนทั้งก้อน */
          ...
          <>
            ...
            <p className={styles.chartNote}>
              {dayUnit === "day"
                ...
                : "สัปดาห์เริ่มวันอาทิตย์ (อา.–ส.) · สัปดาห์หัวท้ายงวดไม่ครบเจ็ดวัน — ชี้ที่แท่งเพื่อดูช่วงวันจริงก่อนสรุปว่าลีดตก"}
            </p>
          </>
        ) : (
