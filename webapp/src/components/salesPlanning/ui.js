...
/* 🐞 ขาดคีย์ `info` มาตั้งแต่ mig 0323 เพิ่มสถานะ "รอหัวหน้ารับรอง" (โทน `info`)
   ⇒ ป้ายของขั้นนั้นตกมาเป็นสตริงว่าง หน้าตาเหมือน "ร่าง" เป๊ะบนทะเบียน ทั้งที่
     คลาสโทน info มีจริงใน globals.css อยู่แล้ว · แผนที่นี้ต้องครอบทุกโทนใน
     `CONTRACT_STATUS_TONES` — เพิ่มสถานะแล้วลืมมาต่อที่นี่ = ป้ายหายเงียบ */
