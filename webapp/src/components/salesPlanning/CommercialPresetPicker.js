...
// ตัวเลือก "ชุดเงื่อนไขการค้า" บนฟอร์มใบเสนอราคา — ใช้ร่วมทั้ง
// เทมเพลตเงื่อนไขการชำระและชุดหมายเหตุ
  ...
  return (
    <div className={styles.picker}>
      ...
      <ConfirmDialog
        ...
        description="วิธีและข้อความเงื่อนไขที่แก้ไว้จะถูกแทนด้วยเนื้อหาของชุดที่เลือก"
