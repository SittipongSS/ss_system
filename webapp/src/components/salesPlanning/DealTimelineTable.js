...
/* บรรทัดรอง "ของจริง" ใต้วันตามแผน (มติผู้ใช้ 2026-08-12 — แบบ B)
   ...
   ของจริง (สแตมตอนคนเดินสถานะ — mig 0239 ขยับไม่ได้) · เซลล์เดียวโชว์ทั้งคู่จึงเทียบได้
   โดยไม่ต้องกวาดตาข้ามคอลัมน์ และตารางไม่กว้างขึ้น
   ขั้นที่ยังไม่ถึงคิว = ไม่มีบรรทัดรอง (ไม่เดาว่าจะช้าหรือไม่)
   ของเก่าก่อน mig 0239 = มีวันเสร็จจริงแต่ไม่มีวันเริ่มจริง — บรรทัดรองฝั่งเริ่มจึงหายไปเฉย ๆ */
