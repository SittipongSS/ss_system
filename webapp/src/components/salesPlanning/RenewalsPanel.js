...
//   (`sales_contracts`) ส่วนที่นี่คือ *ไซต์* — สัญญาใบเดียวครอบได้หลายไซต์ และไซต์เดียว
//   มีหลายโซนที่ทยอยหมด แต่การโทรหาลูกค้าเป็นเรื่องเดียว ⇒ หน่วยของทะเบียนนี้คือไซต์
//   ⚠️ **วันหมดมาจากสัญญาที่ผูกกับใบสั่งขาย** (mig 0324) ไม่ใช่จาก `service_zone_terms`
//     ซึ่งคอลัมน์วันของมันไม่มีใครเขียนเลย (แก้ 06/09/2026 — ก่อนหน้านั้นทะเบียนว่างถาวร)
//
