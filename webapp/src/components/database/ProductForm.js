    ...
    <>
      ...
      <div className="mb-[22px]">
        ...
        <div className="form-grid cols-2">
          {/* หมวดสินค้า ขึ้นก่อนลูกค้า/แบรนด์ (มติผู้ใช้ 2026-08-31) — เดิมอยู่ถัดจาก
              ช่องแบรนด์ ทั้งที่หมวดเป็นตัวกำหนดว่าช่องแบรนด์บังคับ/มีสวิตช์/ไม่มีช่องเลย
              (hasBrandField, brands.js) คนกรอกจึงเจอช่องแบรนด์ก่อนรู้ว่าหมวดต้องการอะไร
              ตัวเลือกหมวดกลางตัวเดียวกับฟอร์มดีล/โครงการ (TwoPanePicker 105 หมวด/4 กลุ่ม)
              — โผล่เฉพาะโหมดระบบใหม่ เพราะโหมดกรอกเองหมวดฝังอยู่ในรหัสที่พิมพ์แล้ว การมี
              ตัวเลือกซ้ำอีกช่องคือการพูดเรื่องเดียวกันสองทาง */}
          {autoCode && (
          ...
          {/* ⭐ ลูกค้าขึ้นก่อนช่องอื่นที่เหลือ — เป็นตัวกำหนดทั้ง **ท่อน AAAA ของรหัส** และชุด
              แบรนด์ที่เลือกได้ (กฎ "ตัวกำหนดบริบทอยู่บนสุด" — หมวดมาก่อนตามกฎเดียวกัน
              เพราะกำหนดว่าช่องแบรนด์เอาไว้ทำอะไรได้บ้าง)
