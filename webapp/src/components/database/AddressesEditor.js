            ...
            <div className="flex flex-wrap items-start gap-2 justify-between">
              <div className="text-[11px] text-[var(--text-3)] min-w-0 flex-1">
                ...
                {/* ⚠️ **เตือน ไม่บล็อก** — ที่อยู่ต่างประเทศไม่มีจังหวัดไทยให้เลือกจริง ๆ
                    ...
                    🪤 อยู่ **นอก** สามทางของ ternary ข้างบนโดยตั้งใจ — แถวที่เพิ่งเพิ่ม
                       ยังไม่ได้ติ๊ก "ออกเอกสาร/จัดส่ง" (isUntouched) ซึ่งคือแถวที่คนกำลัง
                       กรอกอยู่พอดี ถ้าไปแปะไว้ในทางสุดท้าย คำเตือนจะไม่โผล่ตอนที่ต้องการ */}
                {!a.province.trim() && !!a.line1.trim() && !a.addressOverride && (
                  <span className="break-words block text-[var(--amber)] mt-0.5">
                    ยังไม่ได้เลือกจังหวัด — บันทึกได้ แต่เอกสารจะพิมพ์ที่อยู่ไม่ครบ
                  </span>
                )}
              </div>
