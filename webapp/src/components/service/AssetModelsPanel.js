"use client";
// ── แผงทะเบียนรุ่นเครื่อง — แท็บใต้ทะเบียนเครื่อง (mig 0344) ──────────────
//
// ⭐ **รวมเป็นเมนูเดียวกับทะเบียนเครื่อง** (มติผู้ใช้ 2026-09-06) — รุ่นไม่ใช่งาน
//   รายวัน แต่คนที่เข้ามาหามันคือคนเดียวกับที่เปิดทะเบียนเครื่อง และสองหน้านี้
//   อ้างถึงกันตลอด (เพิ่มเครื่องต้องมีรุ่นก่อน · ลบรุ่นต้องรู้ว่ามีเครื่องใช้กี่ตัว)
...
import styles from "./AssetModelsPanel.module.css";

/**
 * @param addSignal  ตัวเลขที่เพิ่มขึ้นเมื่อคนกดปุ่ม "เพิ่มรุ่น" บนหัวหน้า
 *   ⚠️ **ปุ่มอยู่บนหัวหน้า แผงอยู่ข้างล่าง** — หัวหน้าเป็นเจ้าของปุ่มก้าวถัดไปของ
