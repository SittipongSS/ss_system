...
// ⚠️ รูปและลายเซ็น **ไม่บังคับ** (มติผู้ใช้ 2026-07-30) — บังคับแล้วเจ้าหน้าที่จะปิดงาน
  ...
  return (
    <Modal open={open} onClose={onClose} title={`ปิดงาน ${visit.code || ""}`.trim()} size="md">
      ...
      {/* ⭐ เวลาที่เข้าจริง **ประทับที่ server** ตอนกดเริ่ม/ปิดงาน (มติ 2026-08-02 ข้อ 5)
          ...
          นาฬิกาของเครื่องเจ้าหน้าที่ — เปลี่ยนโซนเวลาในมือถือแล้วเวลาที่บันทึกเพี้ยนโดยไม่มี
          อะไรจับได้ และเจ้าหน้าที่ที่ยืนอยู่หน้างานก็ไม่ได้พิมพ์เวลาเองอยู่แล้ว (กรอกทีเดียว
