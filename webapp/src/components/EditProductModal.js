            ...
            <div className="flex items-start gap-3 flex-wrap">
              ...
              <div style={{ flex: "1 1 260px", minWidth: 0 }}>
                <div className="flex items-center gap-2 flex-wrap">
                  <h4 style={{ margin: 0, fontSize: "var(--fs-9)", fontWeight: "var(--fw-bold)", color: "var(--text)" }}>ราคาผลิต</h4>
              ...
              <div style={{ textAlign: "right", minWidth: 150 }}>
                ...
                <div className="font-mono tabular-nums" style={{ color: "var(--text)", fontWeight: "var(--fw-bold)", fontSize: "var(--fs-11)" }}>
              ...
              <div className="mt-4" style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                <div className="form-grid cols-2">
                  ...
                  <div style={{ padding: "12px 14px", background: "var(--panel-2)", border: "1px solid var(--border)", borderRadius: "var(--radius-md)" }}>
                    <div className="flex items-center gap-2" style={{ color: "var(--amber)", fontWeight: "var(--fw-bold)", fontSize: "var(--fs-7)" }}>
