  ...
  return (
    ...
    >
      ...
      {/* บอกผลลัพธ์ตรง ๆ ไม่ใช่ถามว่าแน่ใจไหม — คนกดต้องรู้ว่าชื่อนี้จะไปโผล่ที่ไหนต่อ
          ⚠️ **สามสถานะ ไม่ใช่สอง** — 🐞 รอบแรกเขียนเป็น ternary สองทาง ⇒ กลิ่นที่ยัง
          ไม่มีใครถือและยังไม่ได้เลือกใคร ขึ้นประโยค "กดถอนแล้ว…" ทั้งที่ไม่มีปุ่มถอน
          ให้กดและปุ่มหลักยังกดไม่ได้ (เจอตอนเปิดจริงบนพรีวิว 2026-09-08) */}
      <p className={styles.hint}>
        {pick
          ...
          : (current
            ...
            : "เลือกผู้ปรุงก่อน แล้วปุ่มแจกงานจะกดได้")}
      </p>
