...
/* ── พื้นที่ที่ต้องประเมิน ────────────────────────────────────────────────
   ...
   ⭐ **ชั้นบังคับเฉพาะพื้นที่ใหม่** (mig 0315) — โซนทุกโซนต้องมีชั้น (ช่องบังคับของทะเบียนโซน)
      ⇒ พื้นที่ใหม่ที่จะกลายเป็นโซนตอนกดส่งต้องมีชั้นติดมา · โซนเดิมไม่ต้องถามซ้ำ ชั้นอยู่ในทะเบียนแล้ว
      (เดิมเหตุผลคือชั้นเป็นท่อน FF ของรหัสโซน — ตัดออกจากรหัสแล้วตั้งแต่ mig 0384 แต่ยังบังคับ
       เพราะช่างใช้หาโซนหน้างาน) */
