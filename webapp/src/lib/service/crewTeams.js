// ── ทีมช่างบนหน้าจัดคิว (mig 0310 · งวด T-4) ─────────────────────────────
//
// ⭐ *"TS ก็มีแยกทีม"* — พอฝ่ายช่างมีทีมจริง หน้าจัดคิวต้องอ่านได้ว่า **ทีมไหนแน่นทีมไหนว่าง**
//   ไม่ใช่เห็นช่าง 12 คนเรียงกันโดยไม่รู้ว่าใครอยู่กลุ่มไหน
//
// ⚠️ **ทีมช่างเป็นมุมมอง ไม่ใช่ด่านสิทธิ์** (docs/team-management-plan.md §2) —
...
/* ตัวเลือกตัวกรอง — **ต้องมีถัง "ยังไม่อยู่ทีมไหน" เสมอเมื่อมีคนอยู่ในถังนั้นจริง**
   ถังที่หายไปคือช่างที่หลุดจากสายตาคนจัดคิว */
