// ── คิวงานของช่าง (S-3) — logic ล้วน ──────────────────────────────────────
//
// ⭐ หน้ามือถือของช่างคือ **จุดที่ข้อมูลจริงเข้าระบบ** ถ้าหน้านี้ใช้ยาก ทั้งโมดูลตาย
...
// ── จัดกลุ่มคิวเป็น 4 ก้อนตามที่ช่างคิด ไม่ใช่ตามที่ DB เก็บ ────────────
//
