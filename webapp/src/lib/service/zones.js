...
export function normalizeZoneInput(body = {}, { makeSpotId = null } = {}) {
  ...
  /* ── ชั้น + อาคาร (mig 0314 · บังคับตั้งแต่ 0315) ──────────────────────
     ⭐ **ชั้นบังคับกรอกทุกโซน** และเก็บเป็นค่ามาตรฐาน (04 · GF · B1 · LG) ไม่ใช่ข้อความอิสระ
        ไม่งั้นอาคารเดียวจะมี 'G' 'g' 'ชั้น G' ปนกัน (ชิปลัด · ป้าย · การเรียงใช้ค่าเดียวกัน)
     ⭐ **ไม่อยู่ในรหัสโซนแล้ว** (มติผู้ใช้ 2026-09-24 "ตัด FF ชั้นออก" · mig 0384) — เดิมเป็นท่อน FF
        ของ `ZN-CCCC-FF-DDDDD` · ตอนนี้แก้ชั้นทีหลังได้โดยรหัสไม่เกี่ยว
     ⚠️ อาคารเป็นข้อความอิสระได้ (ไซต์ใหญ่มีตึก A/B/C) */
