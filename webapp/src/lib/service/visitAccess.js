...
//    `service:edit` เหมือนเดิม · **ช่างหน้างาน (Operation) ถือ `service:work`** ซึ่งเปิด
...
/* ── ช่องที่เป็น "แผน" ไม่ใช่ "ผลของการไป" ────────────────────────────────
   🔴 ช่างหน้างานแก้ช่องพวกนี้ไม่ได้ — วันนัด/เวลา/คนไป เป็นคำสัญญาที่แจ้งลูกค้าไปแล้ว
      และเป็นงานของผู้จัดคิว · ไม่กัน = ช่างเลื่อนนัดหนีงานเองได้ และโยนงานให้คนอื่นเงียบ ๆ
...
export const PLANNING_FIELD_ERROR =
  'ช่างแก้ได้เฉพาะผลงานหน้างาน — วันนัด เวลา และผู้รับผิดชอบ ต้องให้ผู้จัดคิวเป็นคนแก้';
