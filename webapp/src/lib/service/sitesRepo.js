...
/* ── คอลัมน์ที่อยู่แยกช่องของไซต์พร้อมหรือยัง (mig 0383) — ตรวจก่อนเขียนไซต์ ─────────────
...
export async function siteAddressColumnsError(supabase) {
  ...
  if (!error) return null;
  return error.code === '42703'
    ? 'ระบบยังไม่พร้อมเก็บที่อยู่แบบแยกช่อง (ยังไม่ได้รัน migration 0383) — แจ้งผู้ดูแลระบบ · ยังไม่ได้บันทึกอะไร'
