...
/* สรุปหัวตาราง — เฉลี่ยเทียบมาตรฐานของเดือนที่ **มีการเข้าจริง** เท่านั้น
   ⚠️ ถ้าเอาเดือนที่ไม่ได้เข้าไปหารด้วย ค่าเฉลี่ยจะต่ำลงทุกครั้งที่เจ้าหน้าที่ไม่ได้ไป
...
/* ป้ายสรุปสำหรับหัวการ์ด — เกิน/ต่ำกว่ามาตรฐานกี่เปอร์เซ็นต์
   ⚠️ ไม่ตัดสินว่า "ผิด" — เกินมาตรฐานอาจแปลว่าขายไว้ต่ำไป ไม่ใช่เจ้าหน้าที่เติมเกิน */
