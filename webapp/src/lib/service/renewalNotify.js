...
//
// ⚠️ **กวาดตอนที่มีคนเปิดทะเบียนต่อสัญญา ไม่ใช่จาก cron** (แพตเทิร์นเดียวกับ
...
//   🪦 บรรทัดนี้เคยเขียนว่า "ระบบนี้ไม่มี cron" ซึ่ง **ไม่จริง** — มี cron อยู่สี่ตัว
//      (`/api/cron/daily-digest` · `auto-bounce-leads` · `close-resolved-issues` ·
//      `drive-orphans`) ตั้งเวลาไว้ใน `vercel.json` · ถ้าวันหนึ่งอยากให้รอบบริการ
//      ถูกกวาดทุกเช้าโดยไม่ต้องรอคนเปิดหน้า ย้ายมาเรียกที่ digest ได้เลย
//      (สัญญาค้างรอลงนามใช้ทางนั้นอยู่แล้ว — ดู lib/sales/contractNotify.js)
//
