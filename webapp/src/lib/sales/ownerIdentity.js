...
// (stale) ค่อยถอยไปจับด้วยชื่อ normalize แล้ว และใช้ชื่อจากบัญชีเป็นค่าแสดงผล
...
//
// ⭐ มติผู้ใช้ 2026-09-14 "ทีมตามดีล": ตัวหานี้ตอบแค่ "ใคร" (รวมคนเปลี่ยนชื่อ/id เก่า + ชื่อที่แสดง)
//    ⛔ ห้ามเอา `team` / `teams` ของบัญชีที่คืนไปจัดยอดเข้าทีม — ทีมของตัวเลขขายมาจากแถวต้นทางเสมอ
//    (sales_deals.team · sales_targets.team · sales_history.team) ดู lib/sales/ownerBucketKey
//    และ lib/sales/personSlice · บัญชีที่คืนมีช่อง team ติดมาตามรูปทะเบียนผู้ใช้เท่านั้น ไม่ใช่ให้ใช้วางเงิน
//
