...
// CHECK ล่าสุด (0199) — เพิ่ม kind ใหม่ในโค้ดโดยไม่แตะ migration แล้วจะแดงทันที
...
const KIND_CHECK_MIGRATION = 'supabase/migrations/0199_lead_events_create_deal_kind.sql';
