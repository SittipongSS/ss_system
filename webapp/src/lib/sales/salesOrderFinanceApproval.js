...
//      ยกเลิกไปแล้ว ปุ่มตีกลับตอนท้ายจึงจะเป็นปุ่มที่กดไม่ได้ตลอดกาลอยู่ดี
//    ⭐ มติ D2 (23/09 · PR1 mig 0376): ทางแก้ใบที่ปิดแล้วคือ AE Sup ย้อนการอนุมัติ → ออก Rev. — งวดย้ายไปใบ Rev.
//      ทั้งแถว และใบ Rev. กลับเข้าคิวให้บัญชีปิดใหม่ (financeStatus ของใบ Rev. เกิดเป็น NULL ไม่สืบจากใบเดิม)
//
