...
test('คนผูกได้ = คนเปิดดีลจากลีดได้ + AE Supervisor (มติ 2026-09-22) · AC/marketing ไม่ได้', () => {
  ...
  // ผังตำแหน่ง 2026-09-24: สาย AC ทุกระดับห้ามผูก · CD/CM ผูกได้เท่า AE Sup (ผู้มีอำนาจตัดสิน)
  ...
  assert.deepEqual([...LEAD_LINK_ROLES].sort(), ['admin', 'ae', 'ae_supervisor', 'commercial_director', 'commercial_manager', 'senior_ae']);
});
