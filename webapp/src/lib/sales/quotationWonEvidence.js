...
export function sanitizeWonAttachments(input) {
...
export function validateWonEvidence({ docType, docDate, paymentDueDate, attachments } = {}) {
  ...
  const files = sanitizeWonAttachments(attachments);
