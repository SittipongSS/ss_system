...
/* ⚠️ เดือนที่นับ Actual มาก่อนเดือน FC เสมอ — ดีลที่ FC ไว้เดือนหนึ่งแต่ปิดได้อีกเดือน
   จะย้ายไปนับ (ทั้ง Actual **และ FC ของตัวเอง**) ที่เดือนที่ปิด ไม่ได้ค้างที่เดือน FC
