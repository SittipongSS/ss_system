...
export function quotationWonEffects({ quote, deal = null, project = null, linkingProject = false } = {}) {
  ...
  return [
    ...
    ...(amount === 0
      ...
      : []),
    // ย้อนการรับเปิดคืนสถานะเดิม (มติ 25/09 · mig 0388) — ทางยกเลิก SO พร้อมย้อน Won ไม่เปิด จึงผูกคำกับ "ย้อนการรับ"
    { id: 'closed', text: 'ใบเสนอราคาฉบับอื่นในดีลนี้ถูกปิด — แก้ไข / ออก Rev. ต่อไม่ได้ · ถ้าย้อนการรับใบนี้ ใบเหล่านั้นเปิดกลับเป็นสถานะเดิม' },
