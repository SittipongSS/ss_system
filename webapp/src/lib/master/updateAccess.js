...
export const UPDATE_ENTITIES = {
  ...
  // อ่าน = ใครที่เห็นระบบธุรกิจบริการ (ฝ่ายขายต้องตอบลูกค้าได้ว่าทำไมเจ้าหน้าที่เลื่อน)
  ...
  service_visit: {
    ...
    // แจ้งเจ้าหน้าที่ที่รับผิดชอบนัดนั้น — ไม่กระจายทั้งฝ่าย (คิวที่เต็มไปด้วยเรื่องคนอื่น
