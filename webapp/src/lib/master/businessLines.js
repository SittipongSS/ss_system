...
// โทนสีประจำสาย (มติผู้ใช้ 2026-08-08: "อยากให้ใช้สีเพื่อช่วยเข้าใจ") —
// **ชื่อโทน ไม่ใช่ค่าสี** เพื่อให้ทุกที่อ่านความหมายจากที่เดียว แล้วแปลงเป็น
// var(--blue)/var(--teal) ที่ชั้น CSS ของแต่ละ surface (แผ่นเลือก · ป้ายในตาราง)
// ⚠️ เป็นสี "ประเภทของงาน" ไม่ใช่สถานะ — ห้ามใช้เขียว/แดง/ส้ม ซึ่งจองไว้ให้
// สำเร็จ/พลาด/accent แล้ว · ส่วน "ยังไม่ระบุสาย" ยังเป็นเหลือง (ตัวทวง ไม่ใช่ประเภท)
export const BUSINESS_LINE_TONES = {
  PRODUCT: 'blue',
  SERVICE: 'teal',
};

export const businessLineTone = (line) => BUSINESS_LINE_TONES[line] || null;
