...
// SB- (พัฒนากลิ่น) · FD- (พัฒนาสูตร) · DC- (ขอเอกสาร RD) · DF- (ขอเอกสารการเงิน FN)
// ⭐ **RQ- เหลือของ "สอบถามข้อมูล" อย่างเดียว** (มติผู้ใช้ 2026-08-18) — เดิมสี่หัวข้อ
// ใช้ร่วมกันจนเปิดคิวมาแล้วแยกไม่ออกว่าใบไหนเป็นงานแบบไหน
// ⚠️ ติดตามของเข้า (PC · material_eta) **ยังเป็น RQ-** — ผู้ใช้ยังไม่ได้สั่งแยก
