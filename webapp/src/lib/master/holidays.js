...
// client param มีไว้ให้ unit test ฉีด fake ได้เท่านั้น — โค้ดจริงเรียกแบบไม่ส่ง arg
export async function listHolidays(client) {
...
export async function holidaySet(client) {
  try {
    const rows = await listHolidays(client);
