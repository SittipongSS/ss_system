...
export const DOC_REF_TYPES = {
  ...
  /* ใบสเปคสินค้า FM-SA-04 (mig 0370 · มติ 21/09/2569) — เลขที่ `FM-SA-04-DDMMYY-XXX` ได้ตอน AC
     ...
     ⚠️ ไม่รับ Rev ต่อท้าย — เลขที่ไม่เปลี่ยนตาม Rev (Rev พิมพ์แยกในช่อง Reversion No.) */
  FM: { label: 'เอกสารใบสเปคสินค้า', table: 'product_spec_documents', column: 'docNo', body: 'SA-04-\\d{6}-\\d{3,}', example: 'FM-SA-04-220969-001', path: (id) => `/sales-planning/spec-documents/${id}` },
