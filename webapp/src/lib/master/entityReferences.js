...
export const REFERENCE_REGISTRY = {
  ...
  product: {
    ...
    tables: [
      ...
      /* ใบสเปคสินค้า FM-SA-04 (mig 0364) — **บล็อกการลบ ไม่ใช่กวาดทิ้ง**
         FK เป็น CASCADE ⇒ ลบสินค้าแล้วใบ ฉบับทุก Rev. และประวัติการออกเอกสารหายไป
         พร้อมกันทั้งสาย · ในนั้นมีเลขที่เอกสารที่ออกให้ลูกค้าไปแล้วและกระดาษที่ลูกค้า
         เซ็นกลับมา ⇒ เป็นหลักฐานของสิ่งที่ตกลงกันไว้ ไม่ใช่สมุดของตัวสินค้าเอง
         (ต่างจาก `product_price_history` ที่เกิดเองตั้งแต่วินาทีสร้างสินค้า)
         ⚠️ ใบเปล่าที่ยังไม่เคยออกเอกสารก็บล็อกด้วย เพราะทะเบียนนี้นับรายตาราง
         ไม่มีเงื่อนไข — ทางออกคือลบใบสเปคก่อน หรือใช้ทางบังคับลบของแอดมิน */
      { table: 'product_specs', label: 'ใบสเปคสินค้า (FM-SA-04)', sample: null },
    ],
    ignored: {
