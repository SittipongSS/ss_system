...
// LEGAL_REGISTRATION_FIELDS แปลว่าทุกครั้งที่ฝ่าย RA อนุมัติ/ตีกลับ/ใส่เลขอนุมัติ
...
test('ทะเบียนไม่คิดสูตรภาษีเอง — อัตรามาจากทะเบียนสินค้าที่เดียว', () => {
  /* ⚠️ **อ่าน** ราคาขายปลีกมาส่งให้จอโชว์เป็นคนละเรื่องกับ **คิดสูตรเอง** — หน้า
     รายละเอียดต้องกางที่มาของภาษีให้ฝ่าย RA เห็น (ราคาปลีก → ถอด VAT → 8% → 10%)
...
/* ⭐ แจ้งข้ามเลน SA ↔ RA — บล็อกนี้เคยเป็น `if` ว่างเปล่าทั้งสองกิ่ง (ตัวส่งถูกถอด
