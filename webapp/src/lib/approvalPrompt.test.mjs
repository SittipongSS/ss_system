...
test('คอนเฟิร์มงวดของใบย้อนหลัง: ไม่มีบรรทัด Rev./Actual ของใบปกติ · บอกด่านเงิน · งวดถัดไป · ไม่นับ Actual', () => {
  ...
  /* งวดปกติ = เงินที่รับในระบบหลังอนุมัติ — ยังล็อกการยกเลิกใบ (ใบย้อนหลังไม่มีทางยก/คืนเงิน)
     🐞 review 25/09: คำเดิม "จนกว่าบัญชีถอนคำรับรอง" ขาดขั้นที่สอง — ถอนคำรับรองพาแถวกลับไป "รอตรวจ" ซึ่งยังบล็อก ⇒ บอกครบสองขั้น */
