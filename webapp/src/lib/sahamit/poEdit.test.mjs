...
test('lineLockReason: บรรทัดที่ settle แล้ว (เชื่อมดีล/QT) ถูกล็อก — กันแก้จำนวน/ลบแล้ว settle ซ้ำ', () => {
  assert.match(lineLockReason({ id: 'L1', status: 'open' }, { isSettled: true }), /เชื่อมดีล/);
});
