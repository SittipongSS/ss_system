...
const SPACE_ENV = {
  ...
  admin: 'CHAT_WEBHOOK_ADMIN', // space ผู้ดูแลระบบ (เรื่องแจ้งปัญหาระบบเข้าคิวใหม่)
};
...
export const CHAT_SPACES = [
  ...
  // เรื่องแจ้งปัญหาระบบเข้าคิว (mig 0219) — ไปที่ **ห้อง ไม่ใช่คน** เพราะตอนเรื่อง
  // เข้ามายังไม่รู้ว่าแอดมินคนไหนจะรับ · กล่องแจ้งเตือนรายคนเริ่มทำงานหลังมีคนกดรับเรื่อง
  { key: 'admin', label: 'ผู้ดูแลระบบ', hint: 'เรื่องแจ้งปัญหาระบบที่ผู้ใช้เพิ่งส่งเข้ามา — คนใน space คือผู้ดูแลระบบ (role admin)' },
];
