...
export const DEFAULT_NUMBERING_PATTERNS = Object.freeze({
  ...
  /* ⚠️ **ใบสเปคสินค้าไม่ออกเลขด้วยรูปแบบนี้** — เลขจริงคือ `FM-SA-04-DDMMYY-XXX` (ปี พ.ศ.)
     ที่ออกจาก RPC `create_product_spec_document` (mig 0370) ตอน AC ออกเอกสารจากบรรทัด SO
     ตัดรอบรายเดือนเหมือน PDR · Rev ของเอกสารพิมพ์แยกในช่อง Reversion No. ไม่ต่อท้ายเลขที่
