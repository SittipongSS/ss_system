 ...
 * คอมเมนต์เดิมที่ว่า "ไม่มี un-confirm ในระบบ" ล้าสมัยตั้งแต่วันนั้น) และงวดที่คอนเฟิร์มแล้ว
 ...
 * ⏭ แผน so-payment-unlock-replan PR1 (ย้ายงวดไปกับใบ Rev.) จะเปลี่ยนบรรทัด Rev. ของใบปกติ — PR0 ยังไม่แตะ
