...
// ฝ่ายที่ "วางคิวผลิตจริง" — ฝ่ายผลิต (PD) เท่านั้น
//
// ⭐ **มติผู้ใช้ 2026-09-16: โมดูลวางแผนผลิตเปิดให้เฉพาะ PD กับ admin** — เดิม PC
// (จัดซื้อ) ถือ production:edit ด้วย · ตัดออกพร้อมกับ PRODUCTION_VIEWER_DEPARTMENTS
// เพราะถ้าตัดแค่ฝั่งอ่าน จะได้ฝ่ายที่ **แก้ตารางได้แต่เปิดหน้าไม่ได้** ซึ่งเป็นทางตัน
export const PRODUCTION_PLANNER_DEPARTMENTS = ['PD'];

/* ฝ่ายที่เปิดโมดูลวางแผนผลิตได้ — **PD เท่านั้น** (มติผู้ใช้ 2026-09-16)

   ⭐ เดิมกว้างถึง PC/WH/QC และฝ่ายขายทุก role (cap `production:view` อยู่ใน
   SALES_OPS + OBSERVER_CAPS) ตามเหตุผล "ต้องตอบลูกค้าได้ว่าผลิตวันไหน" · มติใหม่
   ปิดโมดูลกลับมาเหลือเจ้าของงานจริง ตอนเปิดใช้งานครั้งแรก
...
export const PRODUCTION_VIEWER_DEPARTMENTS = ['PD'];

/* อ่านตารางผลิต — cap อย่างเดียวไม่พอ ต้องอยู่ฝ่าย PD (หรือเป็น admin)
