...
/* 🐞 **เขียน offset ตายตัว (+07:00) ไม่ได้** — ฟังก์ชันที่แบ่งช่องวัน/ช่องเวลาอ่านด้วย
   **เวลาท้องถิ่นของเครื่องที่รัน** ⇒ เครื่องคนเขียนอยู่ไทยเลยผ่าน แต่ CI รันบน UTC
   09:00+07:00 กลายเป็น 02:00 ท้องถิ่น = หลุดนอกราง 09:00–18:00 → เทสต์ตกใน CI ล้วน
   ⇒ ประกอบเวลาจาก **เวลาท้องถิ่น** แล้วค่อยแปลงเป็น ISO ให้ผลเท่ากันทุกโซนเวลา */
const at = (isoDay, time) => {
