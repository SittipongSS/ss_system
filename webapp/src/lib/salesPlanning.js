...
/* ลำดับทีมบนหน้าจอ — ⚠️ ตั้งแต่เปิดให้สร้างทีมขายใหม่ (2026-09-07) ค่าคงที่นี้มีแค่
   สามทีมที่ seed มาแต่แรก ⇒ **ทีมที่สร้างใหม่จะเรียงต่อท้ายเสมอ** (teamRank คืน
   ความยาวลิสต์เมื่อหาไม่เจอ) ซึ่งยอมรับได้: มันเป็นแค่ลำดับการแสดงผล ไม่ใช่ตัวกรอง
   🔴 ห้ามเอาไปใช้เป็น "รายชื่อทีมทั้งหมด" — จอที่ต้องการรายชื่อจริงอ่านจากทะเบียน
   (`lib/master/salesTeamRegistry` ฝั่งจอ · `loadSalesTeamCodes` ฝั่งเซิร์ฟเวอร์) */
