...
> สถานะ: **รอตรวจ** · ตรวจกับโค้ดเมื่อ 2026-08-08 · migration ครบแล้ว เหลือ UAT (ข้อ 7)
> ฉบับแก้ไขครั้งที่ 5 — merge ครบทั้ง 3 PR (PR-1 #729 · PR-2 #731 · PR-3 #732)
> mig 0157/0158 รัน prod 2026-07-26 · **mig 0159 รัน prod แล้ว — ยืนยันกับฐานจริง 2026-08-08**
> (`priceTierQty` มี · `confirmStatus`/`priceSource` ถอนแล้ว · FK ทั้งสองตัวมีครบ)
