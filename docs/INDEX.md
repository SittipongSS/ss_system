...
| [scent-dev-detail-fix-plan.md](scent-dev-detail-fix-plan.md) | **แผนเก็บผลตรวจหน้ารายละเอียดคำร้อง หัวข้อพัฒนากลิ่น** (ตรวจกับ main 2026-08-17 · ใบ SB-26080002) — งวด 1 ✓ (#1295) ตัวนับ PDR ชุดเดียว + เดินสายกระทบยอด SO + คำที่เพี้ยน · งวด 2 ✓ (#1296) จอแคบให้การ์ดจัดการขึ้นก่อน (โหมด `controlFirst`) + ปุ่มแก้กดไม่ได้พร้อมเหตุผล · งวด 3 ✓ รางพกชื่อคน/วันที่จริง + การ์ดใบสั่งขายที่หายไป + ที่มาของช่องที่ระบบเติม · **เหลืองวด 4–5: แยก log ออกจากบทสนทนา · เลนงาน** · สถานะ กำลังดำเนินการ |
