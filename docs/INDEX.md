...
|---|---|---|
| [fm-sa-04-document-model.md](fm-sa-04-document-model.md) | **ใบสเปคสินค้า FM-SA-04 — โมเดลเอกสารชุดใหม่** (มติ 2026-09-21) — สเปคในฐานข้อมูลไม่มีเลข ไม่มี Rev · เลขที่ FM-SA-04-DDMMYY-XXX + Rev + ด่าน AC → AE เจ้าของดีล → AE Sup อยู่ที่เอกสารที่ออกจากบรรทัด SO · แทนโมเดลสามชั้นของ 0364/0369 · mig 0370 | รอตรวจ |
