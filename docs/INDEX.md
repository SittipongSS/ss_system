...
| [role-per-department.md](role-per-department.md) | **ยกเลิก role `staff`** (2026-08-28) — PC/PD/WH/QC/TS ได้ role ของตัวเอง · cap ตรงกับงานจริงตั้งแต่ชั้น role แทน "ถือกว้างแล้วแคบด้วยฝ่าย" · `normalizeRole(role, department)` แปลงโทเคนเก่าตอนอ่าน ⇒ deploy ก่อน แล้วค่อยรันสคริปต์ย้ายบัญชี | รอตรวจ |
