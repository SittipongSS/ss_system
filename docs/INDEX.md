...
| [billing-request-flow-plan.md](billing-request-flow-plan.md) | สายเอกสารการเงิน QT → SO → คำร้อง → FN · **B-1 เสร็จ** (เปิดฝ่าย FN + คิวคำร้องบัญชี) · เหลือ B-2…B-5 | กำลังดำเนินการ |
