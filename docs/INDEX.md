...
| [billing-request-flow-plan.md](billing-request-flow-plan.md) | สายเอกสารการเงิน QT → SO → คำร้อง → FN · **B-1…B-4 เสร็จ** (เปิดฝ่าย FN + คิวคำร้องบัญชี · คำร้องยึด QT พร้อมยอดที่ขอ · เลขที่เอกสารรายบรรทัด · งวดชำระตั้งแต่ร่าง SO + `frozenAt` · mig 0257–0259) · เหลือ B-5 (ผูกคำร้องกับงวด) | กำลังดำเนินการ |
