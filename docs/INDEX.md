...
|---|---|---|
| [historical-sales-orders.md](historical-sales-orders.md) | **ใบสั่งขายย้อนหลัง (SO ย้อนหลัง)** — คีย์งานบริการที่ขายไปแล้วนอกระบบ (มติ 2026-09-14 ข้อ 1–21 + คำตอบคำถามเปิด 2026-09-15) · ตารางเดียว + ธง `origin` (`pipeline`/`historical`) บน `sales_orders`/`sales_deals` · **เก็บยอดจริง กรองที่ตัวคำนวณ** (ไม่นับ Actual/FC/เป้า) · ดีลภาชนะ 1 ใบต่อลูกค้า × AE (AE บังคับ · ย้ายเจ้าของทีละใบ) · TS ผูกโซนในคิวงานเข้าใหม่ · ยกเว้นด่านเงินรายใบ (ข้อ② เท่านั้น) · P1 โค้ดครบในแบรนช์ `claude/legacy-so` · 🔴 **mig 0360 ต้องรันก่อน merge** (dashboard/รายงาน/คิวผลิต/ด่านเข้าไซต์ 500 ถ้าสลับลำดับ) · ⚠️ ต้องมีมติ "TS หาจุดติดตั้งไม่เจอ" ก่อนคีย์ของจริง (เฟส 3) · P2 โมดัลคีย์ 4 ขั้นยังไม่เริ่ม | กำลังดำเนินการ |
