...
| [site-survey-request-plan.md](site-survey-request-plan.md) · [site-survey-mockup.html](site-survey-mockup.html) | **คำร้องประเมินพื้นที่ SA → TS (2026-08-29)** — หัวข้อคำร้องตัวที่ 6 ของฝ่าย TS: SA ขอ → TS ลงคิววันเวลา+ช่าง → ไปวัด ก×ย×ส (เมตร) + รูป → สรุปจำนวนแพ็คเกจต่อโซน → ปิดสองฝั่ง · **ไม่มีตารางใหม่** เพิ่มคอลัมน์ + ขยาย CHECK (`dept_requests.dept` รับ TS · `service_visits.kind` รับ survey · ขนาดที่ `service_zones`) · มติที่ต้องเคาะก่อนลงมืออยู่ §7 · ม็อก 10 จอ | รอตรวจ |
