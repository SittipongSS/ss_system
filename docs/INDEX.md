...
| [excise-system-rework.md](excise-system-rework.md) | รื้อโมดูล `/tax` ทั้งก้อน (2026-08-28) — แจ้งเตือนข้ามเลนที่เคยเป็น `if` ว่างเปล่า · อายุงานนับจากจุดที่สถานะเริ่ม ไม่ใช่วันเปิดใบ · ย้ายคิดภาษี/ความพร้อมเอกสารไป server (เลิกโหลด products 342 + customers 508 ที่หน้าคิว) · `mig 0306` ล้างแท็บท้าย `fgCode` + `/api/nav/counts` เคย 403 ให้ทุก non-admin ทั้งเว็บ | รอตรวจ |
