...
> สถานะ: **กำลังดำเนินการ** · ตรวจกับโค้ดเมื่อ 2026-09-16 · P1 (โครงสร้าง + ตัวเขียน + จุดตัดเรื่องเงิน + คิว TS) **ขึ้น prod แล้ว 16/09/2026 (PR #1723 · mig 0360 รันแล้ว)** · P2a (โมดัลคีย์ 4 ขั้น + ทะเบียน SO) โค้ดครบ รอตรวจ — §8A · P2b ("TS ไม่พบจุดนี้หน้างาน" มติข้อ 23) ยังไม่เริ่ม ต้องมี mig 0361 · เฟส 3 (คีย์ของจริง) รอ P2b
...
3. **TS หาจุดติดตั้งไม่เจอ** — P1 ไม่มีทางออก · บรรทัดค้างในคิวและนับบนป้ายตลอด · undo เดียวคือแอดมินลบทั้งใบก่อน TS ผูก ·
   **เคาะแล้ว 16/09: ทาง ข ตามมติข้อ 23** (TS กด "ไม่พบจุดนี้หน้างาน" พร้อมเหตุผล) — 🔴 รอ P2b ซึ่งต้องมี **mig 0361**
...
**P1 เดินตามลำดับนี้ครบแล้ว (16/09/2026 · #1723)** — เก็บไว้เป็นแบบของ migration รอบถัดไป (P2b/0361)
...
- 🔴 **P2b — จุดที่ TS หาไม่เจอ (มติข้อ 23 · เคาะแล้ว ยังไม่ลงโค้ด)** ต้องมี **mig 0361** (ธง 4 ช่องบนบรรทัด แบบเดียวกับยกเว้นด่านเงิน) ·
  ทาง TS ในคิวงานเข้าใหม่ · ชิป/ตัวกรอง "TS ไม่พบจุด" บนทะเบียน SO · การ์ดตัดสินบนหน้าใบ (แก้ชื่อส่งกลับ / ปิดจุด เก็บยอด) ·
  ข2 ตามมาได้: ถอดบรรทัดออกจากใบ + คิดเงินหัวใบใหม่ · กระดิ่งถึง AE Sup ผู้คีย์ — **ต้องเสร็จก่อนเฟส 3**
