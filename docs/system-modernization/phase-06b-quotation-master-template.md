...
- ฝั่งเอกสารเคย clamp ตอนแสดงอีกชั้น (`printedDiscountValue`) สำหรับป้ายท้ายใบ —
  ถอดออกแล้วเมื่อเอกสารเลิกพิมพ์อัตราทั้งใบ (ดูหัวข้อถัดไป) กติกาที่เหลือคือ clamp
  ฝั่งบันทึกอย่างเดียว ค่าที่เกิน 100 ในแถวเก่าไม่ถูกพิมพ์ออกกระดาษอีกต่อไป

### ส่วนลดท้ายใบก็เป็นยอดเงินล้วนเช่นกัน (มติผู้ใช้ 2026-08-11)

- ป้าย "หัก ส่วนลด X%" ท้ายใบตัด `X%` ออก เหลือ "หัก ส่วนลด" คู่กับยอดเงินที่หัก —
  เอกสารทั้งใบไม่มีอัตราส่วนลดแล้ว ทั้งชั้นบรรทัดและชั้นท้ายใบ (อัตรา VAT ยังอยู่:
  "ภาษีมูลค่าเพิ่ม 7%" เป็นอัตราภาษี ไม่ใช่เงื่อนไขการค้า)
- ผลตามมา: model เอกสารไม่มีคีย์ `discount` แล้ว (ชนิด/อัตราไม่ถูกส่งเข้า renderer)
  ยอดที่หักอ่านจาก `totals.discountAmount` เหมือนเดิม
