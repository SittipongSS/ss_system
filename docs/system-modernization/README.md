...
- [Decision 0005 — Home remains a navigation hub](./decisions/0005-home-remains-navigation-hub.md) (บางข้อถูกแทนที่โดย 0016)
...
- [Decision 0016 — หน้าแรกเป็นเมนูทุกระบบในเปลือกแอป](./decisions/0016-home-is-all-system-menus.md)
