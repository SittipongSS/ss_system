...
- [ ] ผู้ใช้ยืนยันขอบเขต
- [ ] SO พิมพ์ออกมาเป็นหน้าตา V4 (หัว FM-SA-03, อ้างอิง QT, สถานะ, ผู้ลงนาม SO ถูกต้อง)
- [ ] ใบเสนอราคา (QT) หน้าตา/พฤติกรรมไม่เปลี่ยน — เทสต์ QT เดิมเขียวทั้งหมด
- [ ] เทสต์ SO ใหม่ + เทสต์ generalize renderer ผ่าน
- [ ] ตรวจ A4/หลายหน้า/overflow=0 · eslint · build ผ่าน
- [ ] ยืนยันด้วย browser ก่อน commit/PR
