...
| สวิตช์ | แผ่นเลือก 2 ตัวที่หัวใบ (`/sales-planning/quotations/[id]`) ล็อกด้วย `isEditableQuotation` ตัวเดียวกับช่องเนื้อหาอื่น — ยื่น/อนุมัติ/รับแล้วเปลี่ยนไม่ได้ ต้องออก Rev. |
