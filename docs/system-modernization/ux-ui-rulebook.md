...
2. **ขวาบนนอกการ์ด (แถวเดียวกับปุ่มย้อนกลับ)** = action ระดับ entity ของหน้า:
   ...
   สร้างฉบับร่าง) วางเป็นปุ่ม text ในแถวเดียวกันได้
3. **ขวาสุดของ card header** = action ของเนื้อหาในการ์ดนั้น เช่น ปุ่มเพิ่มรายการ —
   ห้ามยกขึ้นไปปนกับ action ระดับหน้า
...
- หน้าที่เข้าได้จากหลายทางอาจใช้ปุ่ม `router.back()` แทนลิงก์คงที่ แต่ตำแหน่งต้องซ้ายบนเสมอ
