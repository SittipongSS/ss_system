...
- [ ] ตรวจ Toast จากการเพิ่ม/แก้ไข/เปลี่ยนสถานะจริงใน environment ที่อนุญาตให้เขียนข้อมูล — ยังไม่ได้ทำ; ย้ายไป Known issues เพราะไม่ mutate ข้อมูล Production เพื่อทดสอบ
- [x] ผู้ใช้ตรวจภาพและการใช้งาน — ยืนยันผ่านการตรวจ Production 19 กรกฎาคม 2026 และการ Merge PR #542
...
- PR: [#542](https://github.com/SittipongSS/ss_system/pull/542) ถูก Merge แล้ว (merge commit `ba61df8`) และ CI ผ่าน
- Migration 0118 ถูกรันบนฐานข้อมูลจริงเมื่อ 19 กรกฎาคม 2026 และตรวจหน้า Production กับข้อมูลจริงแล้วตามบันทึก Visual evidence
- ผู้ยืนยัน: ผู้ใช้เจ้าของระบบ ผ่านการ Merge PR และการใช้งานจริง; Phase 3 และ 4A ต่อยอดจากเฟสนี้แล้ว
- เอกสารนี้ค้างสถานะ `รอตรวจ` ไว้หลัง Merge; ปรับเป็น `เสร็จสมบูรณ์` เมื่อ 20 กรกฎาคม 2026 ให้ตรงกับ Roadmap และสถานะจริง

## Known issues / งานที่เลื่อนไป

- การตรวจ Toast จากการเขียนข้อมูลจริง (เพิ่ม/แก้ไข/เปลี่ยนสถานะ) ยังไม่ได้ทำใน environment ที่อนุญาตให้เขียน; มี unit/API validation ครอบพฤติกรรมแล้ว ให้ตรวจร่วมกับการใช้งานจริงครั้งแรกที่มีการแก้ข้อมูล
